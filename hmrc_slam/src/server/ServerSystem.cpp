    ...
    : mNh(Nh), mNhPrivate(NhPrivate), mMaxClients(4), mpUID(new estd::UniqueIdDispenser())
{
    ...
    mServiceSavemap = mNh.advertiseService("hmrcslam_savemap",&ServerSystem::CallbackSaveMap, this);
...
bool ServerSystem::CallbackSaveMap(hmrcslam::ServiceSaveMap::Request &req, hmrcslam::ServiceSaveMap::Response &res) {
