...
//Msgs
#include <hmrcslam_msgs/MP.h>
#include <hmrcslam_msgs/MPred.h>
...
public:
    ...
    MapPoint(hmrcslam_msgs::MP *pMsg, mapptr pMap, commptr pComm, eSystemState SysState, size_t UniqueId = defid, g2o::Sim3 g2oS_wm_wc = g2o::Sim3()); //constructor for messages
    ...
    //---communication---
    void ReduceMessage(hmrcslam_msgs::MP *pMsgFull, hmrcslam_msgs::MPred *pMsgRed);
    void ConvertToMessage(hmrcslam_msgs::Map &msgMap, kfptr pRefKf, g2o::Sim3 mg2oS_wcurmap_wclientmap = g2o::Sim3(), bool bForceUpdateMsg = false);
    void UpdateFromMessage(hmrcslam_msgs::MP *pMsg, g2o::Sim3 mg2oS_wcurmap_wclientmap = g2o::Sim3());
    void UpdateFromMessage(hmrcslam_msgs::MPred *pMsg, g2o::Sim3 mg2oS_wcurmap_wclientmap = g2o::Sim3());
    void WriteMembersFromMessage(hmrcslam_msgs::MP *pMsg, g2o::Sim3 mg2oS_wcurmap_wclientmap);
    bool SetPoseFromMessage(hmrcslam_msgs::MP *pMsg, g2o::Sim3 mg2oS_wcurmap_wclientmap);
    bool SetPoseFromMessage(hmrcslam_msgs::MPred *pMsg, g2o::Sim3 mg2oS_wcurmap_wclientmap);
