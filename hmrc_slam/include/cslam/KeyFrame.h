...
//Msgs
#include <hmrcslam_msgs/KF.h>
#include <hmrcslam_msgs/KFred.h>
...
public:
    ...
    KeyFrame(hmrcslam_msgs::KF* pMsg, vocptr pVoc, mapptr pMap, dbptr pKFDB, commptr pComm, eSystemState SysState,
    ...
    //---communication---
    void ReduceMessage(hmrcslam_msgs::KF *pMsgFull, hmrcslam_msgs::KFred *pMsgRed);
    void ConvertToMessage(hmrcslam_msgs::Map &msgMap, g2o::Sim3 mg2oS_wcurmap_wclientmap = g2o::Sim3(), kfptr pRefKf = nullptr, bool bForceUpdateMsg = false);
    void UpdateFromMessage(hmrcslam_msgs::KF *pMsg, g2o::Sim3 mg2oS_wcurmap_wclientmap = g2o::Sim3());
    void UpdateFromMessage(hmrcslam_msgs::KFred *pMsg, g2o::Sim3 mg2oS_wcurmap_wclientmap = g2o::Sim3());
    void WriteMembersFromMessage(hmrcslam_msgs::KF *pMsg, g2o::Sim3 mg2oS_wcurmap_wclientmap);
    bool SetPoseFromMessage(hmrcslam_msgs::KF *pMsg, g2o::Sim3 mg2oS_wcurmap_wclientmap);
    bool SetPoseFromMessage(hmrcslam_msgs::KFred *pMsg, g2o::Sim3 mg2oS_wcurmap_wclientmap);
