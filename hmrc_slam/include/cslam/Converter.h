...
//Msgs
#include <hmrcslam_msgs/CvKeyPoint.h>
...
public:
    ...
    static hmrcslam_msgs::CvKeyPoint toCvKeyPointMsg(const cv::KeyPoint &kp);
    static cv::KeyPoint fromCvKeyPointMsg(const hmrcslam_msgs::CvKeyPoint &Msg);
